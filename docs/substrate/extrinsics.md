...
- **summary**:    Update token royalty_beneficiary, quantity, metadata, and royalty. 
...
- **summary**:    Create a common category for trading NFT.  A Selling NFT should belong to a category. 
